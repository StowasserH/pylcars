...
class Menue():
    def menu_click(self, button_name="\n"):
        print "clicked:" + button_name +"  active:" + self.active_page
    ...
    def __init__(self, lcars, fields,rect,button_size,color_use=Conditions.use,color_active=Conditions.active,button_space=4,button_callback=None):
        self.lcars = lcars
        ...
        self.top = Separator(lcars, QtCore.QRect(rx, ry, seperator_width, bh), color_use, bw, orientation=Orientation.top)
        self.buttons = {}
        self.pages = {}
        self.fields = fields
        pos = bh + button_space
        ...
        self.bot = Separator(lcars, QtCore.QRect(rx, rh-bh, seperator_width, bh), color_use, bw, orientation=Orientation.bottom)
